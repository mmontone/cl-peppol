...
(DEFVAR |ISO 3166-1:Alpha2 Country codes|
  '(("Andorra" . "AD") ("United Arab Emirates" . "AE") ("Afghanistan" . "AF")
    ...
    ("India" . "IN") ("British Indian Ocean Territory" . "IO") ("Iraq" . "IQ")
    ("Iran, Islamic Republic of" . "IR") ("Iceland" . "IS") ("Italy" . "IT")
    ("Jersey" . "JE") ("Jamaica" . "JM") ("Jordan" . "JO") ("Japan" . "JP")
    ("Kenya" . "KE") ("Kyrgyzstan" . "KG") ("Cambodia" . "KH")
    ("Kiribati" . "KI") ("Comoros" . "KM") ("Saint Kitts and Nevis" . "KN")
    ("Korea, Democratic People's Republic of" . "KP")
    ("Korea, Republic of" . "KR") ("Kuwait" . "KW") ("Cayman Islands" . "KY")
    ("Kazakhstan" . "KZ") ("Lao People's Democratic Republic" . "LA")
    ...
    ("Puerto Rico" . "PR") ("Palestine, State of" . "PS") ("Portugal" . "PT")
    ("Palau" . "PW") ("Paraguay" . "PY") ("Qatar" . "QA") ("Réunion" . "RE")
    ...
    ("Sint Maarten (Dutch part)" . "SX") ("Syrian Arab Republic" . "SY")
