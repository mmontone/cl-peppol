...
(DEFVAR |Item type identification code (UNCL7143)|
  '(("Product version number" . "AA") ("Assembly" . "AB")
    ("HIBC (Health Industry Bar Code)" . "AC") ("Cold roll number" . "AD")
    ("Hot roll number" . "AE") ("Slab number" . "AF")
    ("Software revision number" . "AG")
    ("UPC (Universal Product Code) Consumer package code (1-5-5)" . "AH")
    ("UPC (Universal Product Code) Consumer package code (1-5-5-1)" . "AI")
    ("Sample number" . "AJ") ("Pack number" . "AK")
    ...
    ("UPC (Universal Product Code)/EAN (European article number) Shipping container code (1-2-5-5-1)"
     . "AM")
    ("UPC (Universal Product Code) suffix" . "AN") ("State label code" . "AO")
    ("Heat number" . "AP") ("Coupon number" . "AQ") ("Resource number" . "AR")
    ("Work task number" . "AS") ("Price look up number" . "AT")
    ("NSN (North Atlantic Treaty Organization Stock Number)" . "AU")
    ("Refined product code" . "AV") ("Exhibit" . "AW") ("End item" . "AX")
    ("Federal supply classification" . "AY") ("Engineering data list" . "AZ")
    ("Milestone event number" . "BA") ("Lot number" . "BB")
    ("National drug code 4-4-2 format" . "BC")
    ("National drug code 5-3-2 format" . "BD")
    ("National drug code 5-4-1 format" . "BE")
    ("National drug code 5-4-2 format" . "BF") ("National drug code" . "BG")
    ("Part number" . "BH") ("Local Stock Number (LSN)" . "BI")
    ("Next higher assembly number" . "BJ") ("Data category" . "BK")
    ("Control number" . "BL") ("Special material identification code" . "BM")
    ("Locally assigned control number" . "BN") ("Buyer's colour" . "BO")
    ("Buyer's part number" . "BP") ("Variable measure product code" . "BQ")
    ("Financial phase" . "BR") ("Contract breakdown" . "BS")
    ("Technical phase" . "BT") ("Dye lot number" . "BU")
    ...
    ("Original equipment number" . "BZ") ("Industry commodity code" . "CC")
    ("Commodity grouping" . "CG") ("Colour number" . "CL")
    ("Contract number" . "CR") ("Customs article number" . "CV")
    ("Drawing revision number" . "DR") ("Drawing" . "DW")
    ("Engineering change level" . "EC") ("Material code" . "EF")
    ("International Article Numbering Association (EAN)" . "EN")
    ("Fish species" . "FS") ("Buyer's internal product group code" . "GB")
    ("National product group code" . "GN")
    ("General specification number" . "GS") ("Harmonised system" . "HS")
    ("ISBN (International Standard Book Number)" . "IB")
    ("Buyer's item number" . "IN")
    ("ISSN (International Standard Serial Number)" . "IS")
    ("Buyer's style number" . "IT") ("Buyer's size code" . "IZ")
    ("Machine number" . "MA")
    ("Manufacturer's (producer's) article number" . "MF")
    ("Model number" . "MN") ("Product/service identification number" . "MP")
    ("Batch number" . "NB") ("Customer order number" . "ON")
    ("Part number description" . "PD") ("Purchaser's order line number" . "PL")
    ("Purchase order number" . "PO") ("Promotional variant number" . "PV")
    ("Buyer's qualifier for size" . "QS")
    ("Returnable container number" . "RC") ("Release number" . "RN")
    ("Run number" . "RU") ("Record keeping of model year" . "RY")
    ("Supplier's article number" . "SA")
    ("Standard group of products (mixed assortment)" . "SG")
    ("SKU (Stock keeping unit)" . "SK") ("Serial number" . "SN")
    ("RSK number" . "SRS")
    ...
    ("Slaughter number" . "SRX") ("Official animal number" . "SRY")
    ("Harmonized tariff schedule" . "SRZ")
    ("Supplier's supplier article number" . "SS") ("46 Level DOT Code" . "SSA")
    ("Airline Tariff 6D" . "SSB")
    ("Title 49 Code of Federal Regulations" . "SSC")
    ("International Civil Aviation Administration code" . "SSD")
    ("Hazardous Materials ID DOT" . "SSE") ("Endorsement" . "SSF")
    ("Air Force Regulation 71-4" . "SSG") ("Breed" . "SSH")
    ...
    ("French classification system IFLS5" . "SSZ") ("Style number" . "ST")
    ...
    ("IMEI" . "SUF") ("Waste Type (EMSA)" . "SUG")
    ("Ship's store classification type" . "SUH")
    ("Emergency fire code" . "SUI") ("Emergency spillage code" . "SUJ")
    ("IMDG packing group" . "SUK") ("MARPOL Code IBC" . "SUL")
    ("IMDG subsidiary risk class" . "SUM") ("Transport group number" . "TG")
    ("Taxonomic Serial Number" . "TSN") ("IMDG main hazard class" . "TSO")
    ("EU Combined Nomenclature" . "TSP")
    ("Therapeutic classification number" . "TSQ")
    ("European Waste Catalogue" . "TSR") ("Price grouping code" . "TSS")
    ("UNSPSC" . "TST") ("Ultimate customer's article number" . "UA")
    ("UPC (Universal product code)" . "UP") ("Vendor item number" . "VN")
    ("Vendor's (seller's) part number" . "VP")
    ("Vendor's supplemental item number" . "VS")
    ("Vendor specification number" . "VX") ("Mutually defined" . "ZZZ")))

(EXPORT '|Item type identification code (UNCL7143)| :PEPPOL/CODE-LISTS)